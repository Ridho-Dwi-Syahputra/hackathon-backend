...
const authMiddleware = async (req, res, next) => {
    try {
        ...
        const users = await db.query('SELECT users_id, email, full_name, total_xp, status, user_image_url, fcm_token, notification_preferences FROM users WHERE users_id = ? AND status = "active"', [decoded.users_id]);
        ...
        req.user = {
            id: user.users_id, // Map users_id ke id untuk consistency (fix favorite bug)
